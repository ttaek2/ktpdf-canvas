  ...
  public render(): JSX.Element {
    ...
    return (
      <div>
        ...
        <p><a href={`${url}:${port_node}/document?docNo=20190401500000001&regId=user01`}>포탈 호출 생성자 페이지_new</a></p>
        ...
        <p><a href={`${url}:${port_node}/document?docNo=20190401500000002&tmpDocNo=20190401500000001&regId=user01`}>포탈 호출 생성자 템플릿 페이지_new</a></p>
        <p><a href={'/contract?docNo=20190401500000001&signerNo=user01'}>서명자 페이지</a></p>
        <p><a href={'/complete?docNo=20190401500000001&signerNo=user01'}>생성자 확인 페이지</a></p>
