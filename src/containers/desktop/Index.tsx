  ...
  public render(): JSX.Element {
    return (
      <div>
        ...
        <p><a href={'http://localhost:3000/document?params={"docId":"190001","regId":"signer1","tmpDocId":"","docPath":"http://localhost:8888/escDoc/pdf/sample.pdf","docName":"테스트.pdf","signers":[{"signerId":"signer1","signerNm":"생성자","signerNo":1},{"signerId":"signer2","signerNm":"유저2","signerNo":2},{"signerId":"signer3","signerNm":"유저3","signerNo":3},{"signerId":"signer4","signerNm":"유저4","signerNo":4},{"signerId":"signer5","signerNm":"유저5","signerNo":5},{"signerId":"signer6","signerNm":"유저6","signerNo":6}]}'}>포탈 호출 생성자 페이지</a></p>
